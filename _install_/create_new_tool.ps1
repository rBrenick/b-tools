...
$CURRENT_TOOLNAME = "b_tools"
$CURRENT_TOOLNAME_RAW = "b-tools"
...
# Find instances of b_tools in files and replace them with the new tool name
...
Foreach-Object {
    ...
    ((Get-Content -path $_.FullName -Raw) -replace "b_tools", $NEW_TOOLNAME_CLEAN) | Set-Content -Path $_.FullName
